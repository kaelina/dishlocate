...
class Restaurants extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('restaurant, website', 'required'),
			array('restaurant, website', 'length', 'max'=>100),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, restaurant, website', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
            'locations' => array(self::HAS_MANY, 'Locations', 'restaurantId'),
            'menuitems' => array(self::HAS_MANY, 'menuitems', 'restaurantId'),
		);
	}
