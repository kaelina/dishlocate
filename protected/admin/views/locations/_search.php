...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->label($model,'metroId'); ?>
		<?php echo $form->textField($model,'metroId'); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'restaurantId'); ?>
		<?php echo $form->textField($model,'restaurantId'); ?>
	</div>
	...
	<div class="row">
		<?php echo $form->label($model,'isOpen'); ?>
		<?php echo $form->textField($model,'isOpen'); ?>
	</div>
